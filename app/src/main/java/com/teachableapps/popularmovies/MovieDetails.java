...
public class MovieDetails extends AppCompatActivity  implements TrailerAdapter.ListItemClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //trailers
        RecyclerView mTrailerRecyclerView = findViewById(R.id.rv_trailers);
        ...
        AppExecutors.getInstance().diskIO().execute(new Runnable() {
            @Override
            public void run() {
                final FavoriteMovieEntity fmov = mDb.movieDao().loadMovieById(Integer.parseInt(movieItem.getId()));
    ...
    private void populateDetails() {
        ...
        mFavButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final FavoriteMovieEntity mov = new FavoriteMovieEntity(
